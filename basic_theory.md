# NETWORK ADMINISTRATION BASIC THEORY #
...
------------------------------------------------------------------------------------------
# Использование шлюза по умолчанию для маршрутизации  <a name="gateway"></a>
...
------------------------------------------------------------------------------------------
# Понятие порта с точки зрения IP и его использование при подключении к другому устройству <a name="device"></a>
